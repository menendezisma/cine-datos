...
#result=result.reindex(columns=['Title', 'Dia inicial', 'Primer Fin de semana', 'Primera semana', 'Primera Semana PCT', 'Segunda semana', 'Segunda Semana PCT', 'Restante', 'Total'])
print(result)
#result.to_excel('resultado4.xlsx')
